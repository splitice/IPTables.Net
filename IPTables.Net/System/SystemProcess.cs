...
#if DEBUG
        public SystemProcess(SshCommand process)
        {
            _command = process;
        }
#endif

        public static SystemProcess Start(ProcessStartInfo info)
        {
            Console.WriteLine(info.FileName + " " + info.Arguments);
#if DEBUG
            var e = SystemSsh.Instance.Execute(info.FileName + " " + info.Arguments);
            return new SystemProcess(e);
#else
            ...
            return new SystemProcess(Process.Start(info));
#endif
        }
