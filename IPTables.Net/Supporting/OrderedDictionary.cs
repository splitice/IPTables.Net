...
namespace IPTables.Net.Supporting
{
    ...
    public class OrderedDictionary<TKey, TValue> : IOrderedDictionary<TKey, TValue>
    {
        ...
        private Dictionary<TKey, TValue> Dictionary
        {
            get
            {
                if (null == _dictionary) _dictionary = new Dictionary<TKey, TValue>(_initialCapacity, _comparer);
                return _dictionary;
            }
        }
        ...
        private List<KeyValuePair<TKey, TValue>> List
        {
            get
            {
                if (null == _list) _list = new List<KeyValuePair<TKey, TValue>>(_initialCapacity);
                return _list;
            }
        }
        ...
        public int IndexOfKey(TKey key)
        {
            ...
            for (var index = 0; index < List.Count; index++)
            {
                ...
                if (null != _comparer)
                {
                    if (_comparer.Equals(next, key)) return index;
                }
