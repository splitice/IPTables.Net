...
namespace IPTables.Net.Tests
{
    ...
    internal class IpTablesSaveReading
    {
        ...
        public void TestParseBlocklist()
        {
            ...
            Dictionary<string, List<IpTablesRule>> rules = Processor.GetRulesFromOutput(toParse, "filter");
        ...
        public static void TestParsePortForward()
        {
            ...
            Dictionary<string, List<IpTablesRule>> rules = Processor.GetRulesFromOutput(toParse, "nat");
        }
    }
}