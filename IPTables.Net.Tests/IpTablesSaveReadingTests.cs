...
namespace IPTables.Net.Tests
{
    ...
    internal class IpTablesSaveReadingTests
    {
        ...
        public void TestParseBlocklist()
        {
            ...
            Dictionary<string, List<IpTablesRule>> rules = Processor.GetRulesFromOutput(toParse, "filter", null);
        ...
        public static void TestParsePortForward()
        {
            ...
            Dictionary<string, List<IpTablesRule>> rules = Processor.GetRulesFromOutput(toParse, "nat", null);
        }
    }
}